...
$query = "SELECT * FROM websites WHERE url = '$websiteUrl'";
...
if ($result->num_rows > 0) {
    ...
    if (preg_match($patternWpContent, $htmlContent, $matches)) {
        ...
        */
        ...
        $query = "INSERT INTO websites (url, detected) VALUES ('$websiteUrl', true)";
        $db->query($query);
        ...
        $query = "INSERT INTO websites (url, detected) VALUES ('$websiteUrl', false)";
        $db->query($query);
    }
